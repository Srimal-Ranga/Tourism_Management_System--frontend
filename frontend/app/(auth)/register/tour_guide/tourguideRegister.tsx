...
import { Mail, User, Lock, Eye, EyeOff, Phone, Briefcase } from "lucide-react";
...
const TourGuideRegisterForm = () => {
  ...
  const handleSubmit = () => {
    // Save step 1 data to sessionStorage for use in step 2
    sessionStorage.setItem("tourguide_step1", JSON.stringify({
      firstName, lastName, email, mobile, experience, password,
    }));
    // Navigate to step 2
    router.push("/register/tour_guide/SecondTourguideRegister");
  };
  ...
  return (
    <>
      ...
      <div className="mb-5" style={{ animation: "fadeSlideIn 0.35s ease forwards" }}>
        ...
        <h2 className="text-2xl font-bold text-gray-900">Become a Tour Guide</h2>
        {/* Step progress */}
        <div className="mt-2">
          <p className="text-sm text-gray-500 mb-2">Step 1 of 3 — Account Details</p>
      ...
      <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <div className="relative">
              <select
                ...
                className="appearance-none pl-3 pr-7 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:outline-none text-gray-900 text-sm bg-white"
              >
            ...
            <div className="relative flex-1">
              <Phone className="absolute left-3 top-2.5 text-gray-300 w-4 h-4" />
              <input
                type="tel"
                placeholder="555-000-7771"
                value={mobile}
        ...
        <div>
          ...
          <div className="relative">
            <Briefcase className="absolute left-3 top-2.5 text-gray-300 w-4 h-4" />
            <input
              type="number"
              placeholder="e.g. 3"
              value={experience}
